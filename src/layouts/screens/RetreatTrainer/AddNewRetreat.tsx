...
interface Props {}
export const AddNewRetreat: FC<Props> = ({navigation, route}): JSX.Element => {
  ...
  const fetchFrachise = async data => {
    ...
    try {
      ...
      const response: any = await FormPostMethod('user-add-retreat', formData);
  ...
  return (
    <>
      ...
      <View style={styles.container}>
        <Text style={styles.title}>Create Retreat</Text>
