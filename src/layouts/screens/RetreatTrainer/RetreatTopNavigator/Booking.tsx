...
interface Props {}
const Booking: FC<Props> = ({navigation, route}): JSX.Element => {
  ...
  const BookingLisfun = async () => {
    ...
    setLoading(true);
    try {
      endpoint = `user-retreat-booking-list?user_id=${login_id}`;
            ...
            <Pressable
              ...
              <View style={styles.row1}>
                ...
                <View>
                  ...
                  <Text style={styles.course}>{item['retreat name']}</Text>
                </View>
              </View>
              <View>
                <View style={styles.row1}>
                  <Icon
                    ...
                    color="black"
                  />
                  <Text style={styles.date}>{item['payment status']}</Text>
                </View>
                <View style={styles.row1}>
