...
interface Props {}
const AddRetreatLeadFollow: FC<Props> = ({navigation, route}): JSX.Element => {
  ...
  const handleConfirm = date => {
    ...
    setValue('follow_up_date', formattedDate);
  };
  ...
  const updatestatusFun = async data => {
    ...
    try {
      ...
      const response = await postMethod(
        'user-retreat-lead-followup-create',
        row,
      );
...
export default AddRetreatLeadFollow;
