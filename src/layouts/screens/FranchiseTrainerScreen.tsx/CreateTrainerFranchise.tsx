...
interface Props {}
export const CreateTrainerFranchise: FC<Props> = ({
  navigation,
  route,
}): JSX.Element => {
  ...
  const fetchFrachise = async data => {
    ...
    try {
      ...
      console.log(row, 'fdf');
      const response: any = await postMethod('franchise-add-by-user', row);
  ...
  return (
    <>
      ...
      <View style={styles.container}>
        <Text style={styles.title}>Create Franchise</Text>
          ...
          <View>
            ...
            <Controller
              ...
              <Controller
                ...
                render={({field: {onChange, value}}) => (
                  <RNPickerSelect
                    placeholder={{label: 'Year of Establishment ', value: null}}
                    items={years}
                    style={{
                      inputIOS: {
