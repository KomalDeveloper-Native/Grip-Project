...
interface Props {}
const AddFranchiseFollowUp: FC<Props> = ({navigation, route}): JSX.Element => {
  ...
  const updatestatusFun = async data => {
    ...
    try {
      ...
      console.log(row);
      const response = await postMethod('franchise-lead-add-followup', row);
...
export default AddFranchiseFollowUp;
