...
interface Props {}
const CandidateScreen: FC<Props> = ({navigation, route}): JSX.Element => {
    ...
    <View style={styles.container}>
      <ScrollView
        ...
        {loading ? (
          ...
          job.map(item => (
            <Pressable style={styles.row} key={item.id} >
                ...
                <View>
                  ...
                  <View style={styles.row1}>
                    <Icon
                      ...
                      color="black"
                    />
                    <Text style={styles.newDate}>{item['Joined since']}</Text>
                  </View>
                </View>
              </View>
            </Pressable>
