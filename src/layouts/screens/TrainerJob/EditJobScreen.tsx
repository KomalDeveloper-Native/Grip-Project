...
export const EditJobScreen: FC<Props> = ({navigation, route}): JSX.Element => {
  ...
  useEffect(() => {
    ...
    setValue('pay_range', Jobdata.pay_range);
    setValue('job_type', Jobdata.job_type);
    setValue('location_type', Jobdata.location_type); // Set location_type from Jobdata
  }, [Jobdata, setValue]);
              ...
              <Controller
                ...
                render={({field: {onChange, value}}) => (
                  <Dropdown
                    ...
                    value={value || Jobdata.location_type} // This will hold the current value from the form
