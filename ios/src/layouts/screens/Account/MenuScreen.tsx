...
const MenuScreen: FC<Props> = ({navigation}): JSX.Element => {
  ...
  return (
    <View style={styles.container}>
      <AppBarSearch navigation={navigation} icon={''} />
      <ScrollView>
                  ...
                  <View style={styles.row}>
                    ...
                    <View>
                      <Text style={{marginLeft: -5}}>
                        {renderStars(item.review.fullstar)}
                      </Text>
        ...
        <View style={{marginBottom: 0,marginTop:15}}>
          <Text style={[styles.text, {marginBottom: -1}]}>Trainers</Text>
            ...
            {trainer.map(item => (
              <Pressable
                ...
                <View style={styles.row3}>
                  ...
                  <Text style={styles.text4}>{item.course}</Text>
                </View>
                <View style={styles.row3}>
                  <Text>{renderStars(item.review.fullstar)}</Text>
                  <Text style={styles.review}>
                    Reviews ({item.review.reviewCount})
                  </Text>
                </View>
          ...
          <ScrollView horizontal style={{marginBottom: 10, marginTop: 20}}>
            {blog.map(item => (
              <View style={[styles.scrollSlide, {width: 'none'}]}>
