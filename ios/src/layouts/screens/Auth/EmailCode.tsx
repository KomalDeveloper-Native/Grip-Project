...
import {ActivityIndicator, Image, Keyboard, KeyboardAvoidingView, Pressable, StyleSheet, Text, View} from 'react-native';
import {
  responsiveWidth,
  responsiveHeight,
  responsiveFontSize,
              ...
              {errors.newPassword && errors.newPassword.type === 'minLength' && (
                <View style={styles.row}>
                  ...
                  <Text style={styles.error}>
                    Password must include uppercase, lowercase, numeric, and special
