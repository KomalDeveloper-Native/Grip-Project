...
function CustomTopNavigator({state, descriptors, navigation, position}) {
  return (
    <>
      ...
      <View style={styles.row0}>
        ...
        />
        <Image source={require('../img/grip.png')} style={styles.logoImage} />
        </View>
...
const styles = StyleSheet.create({
  ...
  activeTab: {
    width: responsiveWidth(27), // Adjust the width as needed
